          ...
          <>
            <Row>
              <InputGroup>
                ...
                />
                <small>{getErrorMsg('fullName', form.errors.fullName)}</small>
              </InputGroup>
              <InputGroup>
                ...
                <input
                  ...
                  onBlur={form.handleBlur}
                />
                <small>{getErrorMsg('email', form.errors.email)}</small>
              </InputGroup>
              <InputGroup>
                ...
                <input
                  ...
                  onBlur={form.handleBlur}
                />
                <small>{getErrorMsg('cpf', form.errors.cpf)}</small>
              </InputGroup>
            </Row>
            ...
            <Row>
              <InputGroup>
                ...
                />
                <small>
                  {getErrorMsg('deliveryEmail', form.errors.deliveryEmail)}
                </small>
              </InputGroup>
              <InputGroup>
                ...
                <>
                  <Row>
                    <InputGroup>
                      ...
                      />
                      <small>
                        {getErrorMsg('cardOwner', form.errors.cardOwner)}
                      </small>
                    </InputGroup>
                    <InputGroup>
                      ...
                      />
                      <small>
                        {getErrorMsg('cpfCardOwner', form.errors.cpfCardOwner)}
                      </small>
                    </InputGroup>
                  </Row>
                  <Row marginTop="24px">
                  ...
                  <Row marginTop="24px">
                    <InputGroup maxWidth="150px">
                      ...
                      <small>
                        {getErrorMsg('installments', form.errors.installments)}
                      </small>
                    </InputGroup>
                  </Row>
                </>
